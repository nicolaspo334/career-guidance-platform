...
const CAREERS = [
  { id: 'ingenieria_software',   name: 'Ingeniería de Software',        area: 'Tecnología',   description: 'Desarrollo y diseño de sistemas informáticos y aplicaciones.',                        mbti:{EI:30,SN:45,TF:80,JP:65}, riasec:{R:44,I:84,A:23,S:14,E:15,C:77}, neo:{O:65,C:70,E:35,A:45,N:40}, future:95 },
  { id: 'ciencias_datos',        name: 'Ciencia de Datos e IA',         area: 'Tecnología',   description: 'Análisis de datos masivos y desarrollo de modelos de inteligencia artificial.',      mbti:{EI:25,SN:40,TF:85,JP:60}, riasec:{R:19,I:100,A:27,S:11,E:12,C:73}, neo:{O:70,C:72,E:30,A:40,N:38}, future:98 },
  { id: 'robotica',              name: 'Robótica e Ing. Electrónica',   area: 'Tecnología',   description: 'Diseño y programación de sistemas robóticos y electrónicos.',                        mbti:{EI:30,SN:50,TF:82,JP:62}, riasec:{R:86,I:77,A:13,S:8,E:13,C:58}, neo:{O:60,C:68,E:38,A:42,N:40}, future:92 },
  { id: 'medicina',              name: 'Medicina',                      area: 'Salud',        description: 'Diagnóstico, tratamiento y prevención de enfermedades.',                            mbti:{EI:45,SN:65,TF:55,JP:80}, riasec:{R:52,I:91,A:8,S:86,E:20,C:46}, neo:{O:60,C:78,E:45,A:65,N:45}, future:85 },
  { id: 'enfermeria',            name: 'Enfermería',                    area: 'Salud',        description: 'Cuidado y atención directa de pacientes en entornos sanitarios.',                   mbti:{EI:50,SN:65,TF:25,JP:70}, riasec:{R:41,I:62,A:6,S:76,E:23,C:62}, neo:{O:55,C:72,E:52,A:75,N:45}, future:83 },
  { id: 'farmacia',              name: 'Farmacia',                      area: 'Salud',        description: 'Dispensación, desarrollo y control de medicamentos.',                               mbti:{EI:40,SN:68,TF:68,JP:72}, riasec:{R:30,I:78,A:8,S:65,E:27,C:59}, neo:{O:55,C:75,E:40,A:50,N:40}, future:76 },
  { id: 'veterinaria',           name: 'Veterinaria',                   area: 'Salud Animal', description: 'Cuidado, diagnóstico y tratamiento de enfermedades en animales.',                   mbti:{EI:45,SN:60,TF:45,JP:65}, riasec:{R:83,I:83,A:0,S:41,E:12,C:41}, neo:{O:60,C:68,E:48,A:68,N:42}, future:68 },
  { id: 'psicologia',            name: 'Psicología',                    area: 'Salud Mental', description: 'Estudio del comportamiento humano y tratamiento de trastornos mentales.',           mbti:{EI:40,SN:42,TF:25,JP:55}, riasec:{R:1,I:76,A:34,S:93,E:27,C:42}, neo:{O:68,C:58,E:50,A:72,N:48}, future:72 },
  { id: 'derecho',               name: 'Derecho',                       area: 'Jurídico',     description: 'Asesoramiento legal, defensa de derechos y ejercicio de la abogacía.',            mbti:{EI:62,SN:58,TF:72,JP:72}, riasec:{R:2,I:56,A:23,S:41,E:75,C:60}, neo:{O:58,C:72,E:62,A:48,N:45}, future:68 },
  { id: 'finanzas',              name: 'Finanzas y Economía',           area: 'Empresa',      description: 'Gestión de recursos económicos, inversión y análisis financiero.',                 mbti:{EI:42,SN:68,TF:82,JP:78}, riasec:{R:0,I:68,A:13,S:21,E:68,C:76}, neo:{O:52,C:78,E:55,A:42,N:40}, future:80 },
  { id: 'administracion',        name: 'Administración de Empresas',    area: 'Empresa',      description: 'Gestión, planificación y dirección de organizaciones.',                            mbti:{EI:58,SN:62,TF:65,JP:75}, riasec:{R:20,I:23,A:5,S:40,E:100,C:72}, neo:{O:55,C:72,E:62,A:55,N:42}, future:73 },
  { id: 'marketing',             name: 'Marketing y Publicidad',        area: 'Empresa',      description: 'Estrategias de comunicación, branding y promoción de marcas.',                    mbti:{EI:72,SN:38,TF:38,JP:42}, riasec:{R:0,I:32,A:24,S:30,E:100,C:62}, neo:{O:72,C:55,E:75,A:58,N:45}, future:75 },
  { id: 'emprendimiento',        name: 'Emprendimiento e Innovación',   area: 'Empresa',      description: 'Creación y desarrollo de nuevas empresas y proyectos innovadores.',               mbti:{EI:62,SN:32,TF:50,JP:35}, riasec:{R:8,I:11,A:6,S:40,E:100,C:76}, neo:{O:78,C:50,E:75,A:52,N:48}, future:80 },
  { id: 'educacion',             name: 'Educación y Pedagogía',         area: 'Educación',    description: 'Enseñanza y formación de personas en distintas etapas educativas.',               mbti:{EI:58,SN:48,TF:28,JP:65}, riasec:{R:28,I:38,A:47,S:100,E:29,C:45}, neo:{O:58,C:65,E:58,A:80,N:45}, future:60 },
  { id: 'ingenieria_civil',      name: 'Ingeniería Civil',              area: 'Ingeniería',   description: 'Diseño y construcción de infraestructuras y obras públicas.',                     mbti:{EI:42,SN:68,TF:78,JP:72}, riasec:{R:90,I:69,A:20,S:12,E:28,C:60}, neo:{O:50,C:75,E:40,A:45,N:38}, future:72 },
  { id: 'ingenieria_industrial', name: 'Ingeniería Industrial',         area: 'Ingeniería',   description: 'Optimización de procesos productivos y gestión de sistemas.',                     mbti:{EI:42,SN:68,TF:76,JP:72}, riasec:{R:66,I:66,A:10,S:6,E:38,C:72}, neo:{O:55,C:72,E:42,A:48,N:40}, future:78 },
  { id: 'arquitectura',          name: 'Arquitectura',                  area: 'Diseño',       description: 'Diseño y planificación de edificios, espacios y entornos urbanos.',              mbti:{EI:38,SN:35,TF:52,JP:62}, riasec:{R:65,I:48,A:52,S:25,E:44,C:57}, neo:{O:80,C:60,E:48,A:55,N:45}, future:65 },
  { id: 'diseño_grafico',        name: 'Diseño Gráfico y UX',           area: 'Diseño',       description: 'Creación de identidades visuales y experiencias de usuario digitales.',          mbti:{EI:38,SN:28,TF:38,JP:32}, riasec:{R:40,I:31,A:100,S:19,E:40,C:49}, neo:{O:82,C:50,E:52,A:58,N:48}, future:78 },
  { id: 'bellas_artes',          name: 'Bellas Artes',                  area: 'Arte',         description: 'Expresión artística a través de pintura, escultura, instalaciones y medios mixtos.', mbti:{EI:30,SN:22,TF:22,JP:22}, riasec:{R:51,I:28,A:100,S:21,E:23,C:22}, neo:{O:88,C:42,E:45,A:58,N:52}, future:45 },
  { id: 'comunicacion',          name: 'Periodismo y Comunicación',     area: 'Comunicación', description: 'Creación y difusión de contenidos informativos y periodísticos.',                mbti:{EI:72,SN:38,TF:35,JP:42}, riasec:{R:8,I:53,A:68,S:30,E:49,C:44}, neo:{O:72,C:52,E:72,A:55,N:45}, future:55 },
  { id: 'biologia',              name: 'Biología e Investigación',      area: 'Ciencias',     description: 'Estudio de los seres vivos, sus procesos y ecosistemas.',                        mbti:{EI:28,SN:38,TF:65,JP:58}, riasec:{R:72,I:100,A:15,S:16,E:1,C:48}, neo:{O:75,C:65,E:35,A:48,N:42}, future:70 },
  { id: 'fisica_matematicas',    name: 'Física y Matemáticas',          area: 'Ciencias',     description: 'Estudio de las leyes fundamentales del universo mediante modelos matemáticos.',  mbti:{EI:25,SN:30,TF:88,JP:55}, riasec:{R:52,I:100,A:33,S:18,E:8,C:65}, neo:{O:80,C:70,E:32,A:42,N:40}, future:75 },
  { id: 'relaciones_int',        name: 'Relaciones Internacionales',    area: 'Social',       description: 'Diplomacia, política exterior y relaciones entre países y organismos.',          mbti:{EI:62,SN:42,TF:55,JP:65}, riasec:{R:0,I:95,A:48,S:40,E:44,C:42}, neo:{O:75,C:60,E:65,A:62,N:42}, future:65 },
  { id: 'trabajo_social',        name: 'Trabajo Social',                area: 'Social',       description: 'Apoyo y acompañamiento a personas en situación de vulnerabilidad.',             mbti:{EI:58,SN:48,TF:15,JP:50}, riasec:{R:12,I:39,A:32,S:98,E:32,C:43}, neo:{O:62,C:58,E:58,A:82,N:48}, future:58 },
  { id: 'historia_humanidades',  name: 'Historia y Humanidades',        area: 'Humanidades',  description: 'Estudio del pasado, la cultura y el pensamiento humano.',                       mbti:{EI:32,SN:32,TF:38,JP:48}, riasec:{R:23,I:72,A:45,S:37,E:22,C:64}, neo:{O:82,C:55,E:38,A:60,N:48}, future:42 },
];
...
// Source: O*NET Work Values (Independence→autonomy, avg(Independence,Achievement)→innovative,
// Relationships→socialImpact, clamp(Achievement-Recognition+50)→growth). Averaged across careers per area.
const AREA_VALUES = {
  'Tecnología':   { autonomy: 64, innovative: 68, socialImpact: 44, growth: 52 },
  'Salud':        { autonomy: 72, innovative: 72, socialImpact: 78, growth: 46 },
  'Salud Animal': { autonomy: 89, innovative: 94, socialImpact: 83, growth: 67 },
  'Salud Mental': { autonomy: 83, innovative: 82, socialImpact: 97, growth: 58 },
  'Jurídico':     { autonomy: 83, innovative: 83, socialImpact: 50, growth: 44 },
  'Empresa':      { autonomy: 76, innovative: 76, socialImpact: 68, growth: 55 },
  'Educación':    { autonomy: 70, innovative: 74, socialImpact: 94, growth: 75 },
  'Ingeniería':   { autonomy: 80, innovative: 76, socialImpact: 47, growth: 47 },
  'Diseño':       { autonomy: 78, innovative: 78, socialImpact: 47, growth: 58 },
  'Arte':         { autonomy: 78, innovative: 78, socialImpact: 50, growth: 67 },
  'Comunicación': { autonomy: 67, innovative: 72, socialImpact: 39, growth: 56 },
  'Ciencias':     { autonomy: 72, innovative: 74, socialImpact: 39, growth: 47 },
  'Social':       { autonomy: 70, innovative: 75, socialImpact: 67, growth: 72 },
  'Humanidades':  { autonomy: 67, innovative: 67, socialImpact: 67, growth: 50 },
};
