...
export default function CambiarContrasena() {
  ...
  const strengthLabel = ['', 'Muy débil', 'Débil', 'Aceptable', 'Buena', 'Excelente'][score ?? 0];
  const strengthColor = ['', 'bg-red-500', 'bg-orange-500', 'bg-yellow-500', 'bg-blue-500', 'bg-green-500'][score ?? 0];
